...
config = Config(EXP_NAME="exp025", TARGET="likes")
...
def get_w2v_hist_mat_col_tec_pro_features(input_df):
    mat_col_tec = pd.concat([historical_person, material, object_collection, technique, production_place], axis=0).reset_index(drop=True)
    params = {
        "size": 32,
        "min_count": 1,
        "window": 1,
