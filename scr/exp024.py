...
config = Config(EXP_NAME="exp024", TARGET="likes")
...
def get_w2v_tec_pro_features(input_df):
    mat_col_tec = pd.concat([technique, production_place], axis=0).reset_index(drop=True)
    params = {
        "size": 32,
        "min_count": 1,
        "window": 1,
