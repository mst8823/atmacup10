...
config = Config(EXP_NAME="exp015", TARGET="likes")
...
def get_basic_text_features(input_df):
    encoder = BasicTextFeatureTransformerEngine(text_columns=["title", "long_title", "more_title", "description", "principal_maker"])
    output_df = encoder.fit_transform(input_df)
    return output_df
