...
from scr.mypipe.models.model_catboost import MyCatRegressor
...
# ---------------------------------------------------------------------- #
# TODO: stacking
config = Config(EXP_NAME="exp065", TARGET="likes")
...
def main():
    ...
    exp_lst = [
        "exp015", "exp016", "exp023", "exp024", "exp025", "exp026", "exp027", "exp029", "exp035", "exp041", "exp043",
        "exp044", "exp044", "exp045", "exp046", "exp047", "exp048", "exp049", "exp050",
        "exp051", "exp052", "exp053", "exp054", "exp055", "exp056", "exp057",
        "exp058", "exp059", "exp060", "exp061"]
    ...
    run_params = {
        ...
        "feature_select_fold": 3,
        "feature_select_num": 700,
        "folds": 5,
