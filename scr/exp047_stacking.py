...
from scr.mypipe.models.model_mlp import MyMLPModel
...
# ---------------------------------------------------------------------- #
# TODO: stacking
config = Config(EXP_NAME="exp047", TARGET="likes")
...
def main():
    ...
    exp_lst = ["exp015", "exp016", "exp023", "exp024", "exp025", "exp026", "exp027", "exp029", "exp035", "exp041",
               "exp043", "exp044"]
    ...
    model_params = {"model": build_model,
                    "scale": True,
                    "multiple_target": False,
                    }

    fit_params = {"epochs": 54,
                  "batch_size": 128,
